...
export const TRAVEL_SCENARIOS = [
  { id: 'airport', title: 'No Aeroporto', icon: Plane, phrases: [
      ...
      { en: "Where is the security checkpoint?", pt: "Onde fica o controlo de segurança?" },
      { en: "How many bags can I check in?", pt: "Quantas malas posso despachar?" },
      { en: "Is my flight on time?", pt: "O meu voo está no horário?" },
      { en: "Which gate is my flight?", pt: "Qual é a porta do meu voo?" },
      { en: "Can I change my seat, please?", pt: "Posso mudar o meu lugar, por favor?" },
      { en: "Is there free Wi‑Fi at the airport?", pt: "Há Wi‑Fi gratuito no aeroporto?" }
  ]},
  { id: 'immigration', title: 'Na Imigração', icon: Shield, phrases: [
      ...
      { en: "This is my return ticket.", pt: "Este é o meu bilhete de regresso." },
      { en: "I am traveling alone.", pt: "Estou a viajar sozinho." },
      { en: "I am traveling with my family.", pt: "Estou a viajar com a minha família." },
      { en: "Here is the address where I will stay.", pt: "Aqui está o endereço onde vou ficar." },
      { en: "I do not carry any food or plants.", pt: "Não trago comida nem plantas." },
      { en: "I am not carrying more than ten thousand dollars.", pt: "Não trago mais de dez mil dólares." },
      { en: "I am a tourist, not a student or worker.", pt: "Sou turista, não estudante nem trabalhador." }
  ]},
  { id: 'hotel', title: 'No Hotel', icon: Bed, phrases: [
      ...
      { en: "Can I check in earlier?", pt: "Posso fazer o check-in mais cedo?" },
      { en: "Is late check-out possible?", pt: "É possível fazer late check-out?" },
      { en: "The air conditioning is not working.", pt: "O ar condicionado não está a funcionar." },
      { en: "There is a problem with the shower.", pt: "Há um problema com o chuveiro." },
      { en: "Can you call a taxi for me?", pt: "Pode chamar um táxi para mim?" },
      { en: "Is breakfast included in the price?", pt: "O pequeno-almoço está incluído no preço?" },
      { en: "Where is the elevator?", pt: "Onde fica o elevador?" }
  ]},
  { id: 'taxi', title: 'No Táxi / Uber', icon: Car, phrases: [
      ...
      { en: "Can you turn on the taximeter?", pt: "Pode ligar o taxímetro?" },
      { en: "Can you drive a little slower, please?", pt: "Pode conduzir um pouco mais devagar, por favor?" },
      { en: "Can you open the trunk?", pt: "Pode abrir a mala do carro?" },
      { en: "I will pay by card.", pt: "Vou pagar com cartão." },
      { en: "Can you wait for me a few minutes?", pt: "Pode esperar por mim alguns minutos?" },
      { en: "Is this the fastest way?", pt: "Este é o caminho mais rápido?" },
      { en: "Thank you for the ride.", pt: "Obrigado pela viagem." }
  ]},
  { id: 'directions', title: 'Pedindo Informações', icon: MapPin, phrases: [
      ...
      { en: "Is there a bus that goes there?", pt: "Há algum autocarro que vá para lá?" },
      { en: "Which line should I take?", pt: "Que linha eu devo apanhar?" },
      { en: "Where is the tourist information center?", pt: "Onde fica o centro de informações turísticas?" },
      { en: "Is this neighborhood safe at night?", pt: "Este bairro é seguro à noite?" },
      { en: "How long does it take to get there?", pt: "Quanto tempo demora para chegar lá?" },
      { en: "Can you show me on the map?", pt: "Pode mostrar-me no mapa?" },
      { en: "Thank you, that was very helpful.", pt: "Obrigado, foi muito útil." }
  ]}
];
...
export const QUIZ_WORDS = [
  ...
  { en: 'Sun', pt: 'Sol', options: ['Lua', 'Estrela', 'Sol', 'Céu'] },
  { en: 'Moon', pt: 'Lua', options: ['Lua', 'Sol', 'Terra', 'Mar'] },
  { en: 'Star', pt: 'Estrela', options: ['Estrela', 'Nuvem', 'Árvore', 'Pedra'] },
  { en: 'Sky', pt: 'Céu', options: ['Céu', 'Rio', 'Lago', 'Montanha'] },
  { en: 'Cloud', pt: 'Nuvem', options: ['Chuva', 'Neve', 'Nuvem', 'Vento'] },
  { en: 'Rain', pt: 'Chuva', options: ['Chuva', 'Neve', 'Areia', 'Fogo'] },
  { en: 'Snow', pt: 'Neve', options: ['Neve', 'Areia', 'Água', 'Fumaça'] },
  { en: 'Wind', pt: 'Vento', options: ['Terra', 'Água', 'Vento', 'Fogo'] },
  { en: 'Tree', pt: 'Árvore', options: ['Folha', 'Raiz', 'Árvore', 'Flor'] },
  { en: 'Leaf', pt: 'Folha', options: ['Folha', 'Flor', 'Fruta', 'Grama'] },
  { en: 'Root', pt: 'Raiz', options: ['Raiz', 'Tronco', 'Caule', 'Semente'] },
  { en: 'River', pt: 'Rio', options: ['Mar', 'Lago', 'Piscina', 'Rio'] },
  { en: 'Lake', pt: 'Lago', options: ['Rio', 'Lago', 'Mar', 'Poço'] },
  { en: 'Sea', pt: 'Mar', options: ['Mar', 'Rio', 'Lago', 'Névoa'] },
  { en: 'Mountain', pt: 'Montanha', options: ['Planície', 'Montanha', 'Floresta', 'Praia'] },
  { en: 'Stone', pt: 'Pedra', options: ['Pedra', 'Árvore', 'Folha', 'Papel'] },
  { en: 'Sand', pt: 'Areia', options: ['Areia', 'Neve', 'Sal', 'Terra'] },
  { en: 'Fire', pt: 'Fogo', options: ['Água', 'Terra', 'Ar', 'Fogo'] },
  { en: 'Water', pt: 'Água', options: ['Água', 'Vento', 'Areia', 'Ferro'] },
  { en: 'Earth', pt: 'Terra', options: ['Terra', 'Vento', 'Água', 'Gelo'] },
  { en: 'Air', pt: 'Ar', options: ['Fogo', 'Ar', 'Água', 'Pedra'] },
  { en: 'Light', pt: 'Luz', options: ['Luz', 'Sombra', 'Estrela', 'Neve'] },
  { en: 'Dark', pt: 'Escuro', options: ['Claro', 'Sol', 'Escuro', 'Luz'] },
  { en: 'Day', pt: 'Dia', options: ['Dia', 'Noite', 'Semana', 'Mês'] },
  { en: 'Night', pt: 'Noite', options: ['Dia', 'Anoitecer', 'Madrugada', 'Noite'] },
  { en: 'Morning', pt: 'Manhã', options: ['Manhã', 'Tarde', 'Noite', 'Ontem'] },
  { en: 'Evening', pt: 'Fim de tarde', options: ['Fim de tarde', 'Manhã', 'Madrugada', 'Hoje'] },
  { en: 'House', pt: 'Casa', options: ['Casa', 'Rua', 'Prédio', 'Loja'] },
  { en: 'Room', pt: 'Quarto', options: ['Cozinha', 'Banheiro', 'Quarto', 'Sala'] },
  { en: 'Door', pt: 'Porta', options: ['Janela', 'Mesa', 'Porta', 'Cadeira'] },
  { en: 'Window', pt: 'Janela', options: ['Porta', 'Parede', 'Janela', 'Telhado'] },
  { en: 'Table', pt: 'Mesa', options: ['Cadeira', 'Mesa', 'Sofá', 'Cama'] },
  { en: 'Chair', pt: 'Cadeira', options: ['Mesa', 'Cama', 'Cadeira', 'Porta'] },
  { en: 'Bed', pt: 'Cama', options: ['Cama', 'Mesa', 'Janela', 'Sofá'] },
  { en: 'Kitchen', pt: 'Cozinha', options: ['Banheiro', 'Quarto', 'Cozinha', 'Garagem'] },
  { en: 'Bathroom', pt: 'Banheiro', options: ['Sala', 'Banheiro', 'Quintal', 'Cozinha'] },
  { en: 'School', pt: 'Escola', options: ['Biblioteca', 'Escola', 'Mercado', 'Hospital'] },
  { en: 'Teacher', pt: 'Professor', options: ['Aluno', 'Médico', 'Engenheiro', 'Professor'] },
  { en: 'Student', pt: 'Aluno', options: ['Professor', 'Aluno', 'Diretor', 'Motorista'] },
  { en: 'Book', pt: 'Livro', options: ['Caderno', 'Livro', 'Folha', 'Revista'] },
  { en: 'Pen', pt: 'Caneta', options: ['Lápis', 'Borracha', 'Caneta', 'Pincel'] },
  { en: 'Pencil', pt: 'Lápis', options: ['Lápis', 'Caneta', 'Tesoura', 'Régua'] },
  { en: 'Notebook', pt: 'Caderno', options: ['Livro', 'Caderno', 'Celular', 'Mesa'] },
  { en: 'Bag', pt: 'Mochila', options: ['Bolsa', 'Caixa', 'Mochila', 'Mala'] },
  { en: 'Phone', pt: 'Telefone', options: ['Computador', 'Relógio', 'Telefone', 'Televisão'] },
  { en: 'Computer', pt: 'Computador', options: ['Computador', 'Tablet', 'Celular', 'Rádio'] },
  { en: 'Mouse', pt: 'Mouse', options: ['Teclado', 'Monitor', 'Mouse', 'Livro'] },
  { en: 'Keyboard', pt: 'Teclado', options: ['Mouse', 'Tela', 'Teclado', 'Cabo'] },
  { en: 'City', pt: 'Cidade', options: ['Cidade', 'Campo', 'Praia', 'Floresta'] },
  { en: 'Street', pt: 'Rua', options: ['Estrada', 'Praça', 'Rua', 'Ponte'] },
  { en: 'Car', pt: 'Carro', options: ['Bicicleta', 'Carro', 'Trem', 'Barco'] },
  { en: 'Bus', pt: 'Ônibus', options: ['Moto', 'Avião', 'Ônibus', 'Navio'] },
  { en: 'Train', pt: 'Trem', options: ['Carro', 'Trem', 'Caminhão', 'Helicóptero'] },
  { en: 'Airplane', pt: 'Avião', options: ['Ônibus', 'Trem', 'Avião', 'Navio'] },
  { en: 'Bike', pt: 'Bicicleta', options: ['Carro', 'Moto', 'Bicicleta', 'Patinete'] },
  { en: 'Food', pt: 'Comida', options: ['Bebida', 'Comida', 'Fruta', 'Doce'] },
  { en: 'Bread', pt: 'Pão', options: ['Leite', 'Pão', 'Queijo', 'Bolo'] },
  { en: 'Milk', pt: 'Leite', options: ['Refrigerante', 'Leite', 'Suco', 'Água'] },
  { en: 'Coffee', pt: 'Café', options: ['Chá', 'Café', 'Leite', 'Água'] },
  { en: 'Tea', pt: 'Chá', options: ['Café', 'Chá', 'Suco', 'Refrigerante'] },
  { en: 'Rice', pt: 'Arroz', options: ['Feijão', 'Arroz', 'Batata', 'Macarrão'] },
  { en: 'Bean', pt: 'Feijão', options: ['Arroz', 'Feijão', 'Milho', 'Ervilha'] },
  { en: 'Fruit', pt: 'Fruta', options: ['Fruta', 'Verdura', 'Carne', 'Pão'] },
  { en: 'Apple', pt: 'Maçã', options: ['Banana', 'Maçã', 'Laranja', 'Pera'] },
  { en: 'Banana', pt: 'Banana', options: ['Uva', 'Banana', 'Melancia', 'Abacaxi'] },
  { en: 'Orange', pt: 'Laranja', options: ['Laranja', 'Limão', 'Morango', 'Uva'] },
  { en: 'Grape', pt: 'Uva', options: ['Uva', 'Maçã', 'Pêssego', 'Pera'] },
  { en: 'Strawberry', pt: 'Morango', options: ['Melancia', 'Morango', 'Abacaxi', 'Manga'] },
  { en: 'Meat', pt: 'Carne', options: ['Fruta', 'Pão', 'Carne', 'Legume'] },
  { en: 'Fish', pt: 'Peixe', options: ['Peixe', 'Frango', 'Carne', 'Queijo'] },
  { en: 'Egg', pt: 'Ovo', options: ['Ovo', 'Pão', 'Bolo', 'Manteiga'] },
  { en: 'Sugar', pt: 'Açúcar', options: ['Sal', 'Pimenta', 'Açúcar', 'Óleo'] },
  { en: 'Salt', pt: 'Sal', options: ['Sal', 'Açúcar', 'Farinha', 'Arroz'] },
  { en: 'Happy', pt: 'Feliz', options: ['Triste', 'Bravo', 'Feliz', 'Cansado'] },
  { en: 'Sad', pt: 'Triste', options: ['Feliz', 'Triste', 'Animado', 'Calmo'] },
  { en: 'Big', pt: 'Grande', options: ['Grande', 'Pequeno', 'Largo', 'Curto'] },
  { en: 'Small', pt: 'Pequeno', options: ['Alto', 'Pequeno', 'Largo', 'Forte'] },
  { en: 'Fast', pt: 'Rápido', options: ['Lento', 'Rápido', 'Fraco', 'Pesado'] },
  { en: 'Slow', pt: 'Devagar', options: ['Devagar', 'Rápido', 'Forte', 'Claro'] },
  { en: 'Hot', pt: 'Quente', options: ['Gelado', 'Quente', 'Seco', 'Doce'] },
  { en: 'Cold', pt: 'Frio', options: ['Frio', 'Quente', 'Morno', 'Seco'] },
  { en: 'Clean', pt: 'Limpo', options: ['Sujo', 'Molhado', 'Limpo', 'Velho'] },
  { en: 'Dirty', pt: 'Sujo', options: ['Limpo', 'Novo', 'Sujo', 'Brilhante'] },
  { en: 'Strong', pt: 'Forte', options: ['Fraco', 'Lento', 'Forte', 'Calmo'] },
  { en: 'Weak', pt: 'Fraco', options: ['Forte', 'Rápido', 'Fraco', 'Alto'] },
  { en: 'Easy', pt: 'Fácil', options: ['Difícil', 'Lento', 'Fácil', 'Curto'] },
  { en: 'Difficult', pt: 'Difícil', options: ['Rápido', 'Fácil', 'Difícil', 'Simples'] },
  { en: 'Friend', pt: 'Amigo', options: ['Amigo', 'Inimigo', 'Vizinho', 'Chefe'] },
  { en: 'Family', pt: 'Família', options: ['Família', 'Turma', 'Equipe', 'Bairro'] },
  { en: 'Work', pt: 'Trabalho', options: ['Férias', 'Escola', 'Trabalho', 'Jogo'] },
  { en: 'Money', pt: 'Dinheiro', options: ['Dinheiro', 'Comida', 'Tempo', 'Conta'] },
  { en: 'Game', pt: 'Jogo', options: ['Livro', 'Filme', 'Jogo', 'Música'] },
  { en: 'Time', pt: 'Tempo', options: ['Dinheiro', 'Tempo', 'Relógio', 'Dia'] },
];
